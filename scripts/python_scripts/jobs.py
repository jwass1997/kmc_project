...
if __name__ == "__main__":
    ...
    """ slurm_single_IV(
        ...
        outputIdx=0,
        control_indices=[1, 2, 3, 5, 6, 7],
        control_volts=[ 1.0605,  1.0704, -0.6416, -0.1465, -0.7767,  0.3189],
        minVoltage=-1.5,
        maxVoltage=1.5,
        eq_steps=100_000,
        sim_steps=1_000_000,
        ...
        don_cfg=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data/final_datasets/data_vMB_ring_1e7/configs/uniform_donors_1.txt"),
        ele_cfg=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data/final_datasets/data_vMB_ring_1e7/configs/electrodes.txt"),
        save_folder=Path("/gpfs/bwfor/work/ws/hd_gy283-my_data_new/1d_funcs_BO"),
        file_name=Path(f"BO_func_type={func_type}_data_type=data_vMB_ring_1e7_lam={lam}_input_idx={in_idx-1}"),
        BINARY=Path("/home/hd/hd_hd/hd_gy283/kmc_project/build/kmc_project"),
        SH_SCRIPT=Path("/home/hd/hd_hd/hd_gy283/kmc_project/scripts/slurm/single_curve.sh"),
        OUT_DIR=Path("/home/hd/hd_hd/hd_gy283/kmc_project/slurm_out")
    ) """
    ...
    """ slurm_single_IV(
        numOfPoints=50,
        inputIdx=input_index+1,
        outputIdx=0,
        control_indices=[1, 2, 3, 5, 6, 7],
        control_volts=[-0.4980, -0.5450,  0.7244, -0.0310,  0.4541,  1.3400],
        minVoltage=-1.5,
        maxVoltage=1.5,
        eq_steps=100_000,
        sim_steps=1_000_000,
        ...
        file_name=Path(f"BO_func_type={func_type}_data_type=uni_1e7_lam={lam}_input_idx={input_index-1}"),
        BINARY=Path("/home/hd/hd_hd/hd_gy283/kmc_project/build/kmc_project"),
        SH_SCRIPT=Path("/home/hd/hd_hd/hd_gy283/kmc_project/scripts/slurm/single_curve.sh"),
        OUT_DIR=Path("/home/hd/hd_hd/hd_gy283/kmc_project/slurm_out")
    ) """
    ...
    """ slurm_single_IV(
        ...
        outputIdx=0,
        control_indices=[1, 2, 3, 5, 6, 7],
        control_volts=[ 0.4191, -0.4985, -0.6052,  0.4016,  0.0714,  0.8243],
        minVoltage=-1.5,
        maxVoltage=1.5,
        eq_steps=100_000,
        sim_steps=1_000_000,
        ...
        ele_cfg=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data_recover/final_datasets/grad_towards_1e7/configs/electrodes.txt"),
        save_folder=Path("/gpfs/bwfor/work/ws/hd_gy283-my_data_recover/1d_funcs_BO"),
        file_name=Path(f"BO_func_type={func_type}_data_type=grad_towards_1e7_lam={lam}_input_idx={in_idx-1}"),
        BINARY=Path("/home/hd/hd_hd/hd_gy283/kmc_project/build/kmc_project"),
        SH_SCRIPT=Path("/home/hd/hd_hd/hd_gy283/kmc_project/scripts/slurm/single_curve.sh"),
        OUT_DIR=Path("/home/hd/hd_hd/hd_gy283/kmc_project/slurm_out")
    ) """
    ...
    """ slurm_single_IV(
        ...
        outputIdx=0,
        control_indices=[1, 2, 3, 5, 6, 7],
        control_volts=[ 0.3150,  0.5854,  1.5000, -1.2202, -1.5000,  0.6046],
        minVoltage=-1.5,
        maxVoltage=1.5,
        eq_steps=100_000,
        sim_steps=1_000_000,
        ...
        ele_cfg=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data_recover/final_datasets/grad_away_1e7/configs/electrodes.txt"),
        save_folder=Path("/gpfs/bwfor/work/ws/hd_gy283-my_data_recover/1d_funcs_BO"),
        file_name=Path(f"BO_func_type={func_type}_data_type=grad_away_1e7_lam={lam}_input_idx={in_idx-1}"),
        BINARY=Path("/home/hd/hd_hd/hd_gy283/kmc_project/build/kmc_project"),
        SH_SCRIPT=Path("/home/hd/hd_hd/hd_gy283/kmc_project/scripts/slurm/single_curve.sh"),
        OUT_DIR=Path("/home/hd/hd_hd/hd_gy283/kmc_project/slurm_out")
    ) """
    ...
    """for steps in [10_000_000]:
        slurm_single_device(
            ...
            seed=np.random.randint(low=1, high=2**30),
            cfg=Path(f"/home/hd/hd_hd/hd_gy283/kmc_project/configs/std_configs/config.txt"),
            acc_cfg=Path(f"/home/hd/hd_hd/hd_gy283/kmc_project/configs/std_configs/acc_{n_a}.txt"),
            ...
            file_name=Path(f"acc_{n_a}_10e7"),
            BINARY=Path("/home/hd/hd_hd/hd_gy283/kmc_project/build/kmc_project"),
            SH_SCRIPT=Path("/home/hd/hd_hd/hd_gy283/kmc_project/scripts/slurm/helix_single.sh"),
            OUT_DIR=Path("/home/hd/hd_hd/hd_gy283/kmc_project/slurm_out")
        )"""
