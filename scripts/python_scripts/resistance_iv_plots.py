    ...
    for j in electrode_pairs:
        ...
        for k in range(num_geom):
            slurm_single_IV(
                ...
                cfg=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data/iv_from_paper_with_T/configs/config_paper.txt"),
                acc_cfg=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data/iv_from_paper_with_T/configs/acc_{k}.txt"),
                don_cfg=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data/iv_from_paper_with_T/configs/don_{k}.txt"),
                ele_cfg=Path(f"/home/hd/hd_hd/hd_gy283/kmc_project/configs/std_configs/electrodes.txt"),
                save_folder=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data/iv_from_paper_with_T/en_dis={en_dis}"),
