    ...
    if data_type == 'uni_1e7':
        ...
        for k in range(top_K_num):
            slurm_single_IV(
                ...
                save_folder=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data_recover/1d_funcs_random_mse/{data_type}_{func_type}_topK"),
                file_name=Path(f"random_mse_func_type={func_type}_data_type={data_type}_topk={k}"),
