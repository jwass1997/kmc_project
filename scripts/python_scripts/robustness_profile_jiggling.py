    ...
    if data_type == 'uni_1e7':
        ...
        for k in range(num_cfgs):
            slurm_single_IV(
                ...
                acc_cfg=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data_recover/final_datasets/uni_1e7/configs/jiggled_configs/jiggled_{k}.txt"),
                ...
                save_folder=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data_recover/1d_funcs_random_mse/{data_type}_{func_type}_jiggling"),
                file_name=Path(f"random_mse_func_type={func_type}_data_type={data_type}_jiggled_k={k}"),
    ...
    if data_type == 'data_vMB_ring_1e7':
        ...
        for k in range(num_cfgs):
            slurm_single_IV(
                ...
                acc_cfg=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data_recover/final_datasets/data_vMB_ring_1e7/configs/jiggled_configs/jiggled_{k}.txt"),
    ...
    if data_type == 'grad_towards_1e7':
        ...
        for k in range(num_cfgs):
            slurm_single_IV(
                ...
                acc_cfg=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data_recover/final_datasets/grad_towards_1e7/configs/jiggled_configs/jiggled_{k}.txt"),
    ...
    if data_type == 'grad_away_1e7':
        ...
        for k in range(num_cfgs):
            slurm_single_IV(
                ...
                acc_cfg=Path(f"/gpfs/bwfor/work/ws/hd_gy283-my_data_recover/final_datasets/grad_away_1e7/configs/jiggled_configs/jiggled_{k}.txt"),
